  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-red-50">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600">AI深度解析诗词内容，提供个性化学习路径</p>
            </div>
            ...
            <div className="text-center bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600">基于学习进度和偏好的智能内容推荐系统</p>
            </div>
            ...
            <div className="text-center bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600">全方位学习数据分析，实时监控学习效果</p>
            </div>
            ...
            <div className="text-center bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold mb-2">互动体验</h3>
              <p className="text-gray-600">沉浸式学习环境，让古典文学变得生动有趣</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl font-bold text-center mb-8 text-gray-800">精选古诗文</h2>
